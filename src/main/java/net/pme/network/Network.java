...
public class Network {
     ...
     *
     * @throws IOException          If initialization does not work.
     ...
     *
     * @param p The packet to send to all.
     * @throws IOException When writing the package does not work.
     */
     ...
     * @throws IOException When the socket cannot be closed for some reason.
     */
