...
public abstract class HudWindow extends HudObject implements Focusable {
     ...
     */
    public HudWindow(final int x, final int y) {
        super(x, y);
    }
     ...
     *
     * @param dx The x distance to the last position.
     * @param dy The y distance to the last position.
     */
     ...
     *
     * @param x The x click offset relative to the left top corner of this
     *          window.
     * @param y The y click offset relative to the left top corner of this
     *          window.
     */
